...
<div class="grax_tm_all_wrap" data-magic-cursor="" data-color="crimson">
	...
	<div class="grax_tm_topbar">
		<div class="container">
			<div class="topbar_inner">
				<div class="logo">
					<a class="dark" href="#"><img src="img/logo/dark.png" alt="Logo Masfarre" /></a> 
					<a class="light" href="#"><img src="img/logo/logo.png" alt="Logo Masfarre" /></a>  
				</div>
				<div class="menu">
					<ul class="anchor_nav">
			...
			<div class="container">
				<div class="dropdown_inner">
					<ul class="anchor_nav">
						...
						<li><a href="#about">Nosotros</a></li>
						<li><a href="#portfolio">Servicos</a></li>
						<li><a href="#news">Eventos</a></li>
						<li><a href="#contact">Contacto</a></li>
					</ul>
				</div>
		...
		<div class="content">
			<div class="container">
				<div class="details" data-animation ="scale"> <!-- Animation Values: toTop, toRight, scale, rotate -->
					<h3 class="fn_animation name">Servicios Audiovisuales</h3>
					<span class="fn_animation job"> Hacemos que tu fiesta sea MÁGICA</span>
				</div>
	...
	<div class="grax_tm_section" id="portfolio">
		<div class="grax_tm_portfolio">
			<div class="container">
				<div class="grax_tm_title_holder">
					<h3>Eventos <span>Destacados</span></h3>
				</div>
			...
			<div class="container">
				<div class="talk_inner">
					<div class="text wow fadeInLeft" data-wow-duration="1.5s">
						<h3><span>Estamos disponibles para programar tu evento</span></h3>
					</div>
			...
			<div class="container">
				<div class="copyright_inner">
					...
					<div class="copy wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".4s">
						<p>&copy; Copyright 2024 www.innodesign.com.ar</p>
					</div>
				</div>
			</div>
		</div>
